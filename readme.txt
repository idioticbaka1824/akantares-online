...
~~Controls:
Arrow keys (or drag 'Direction' slider) to change angle. Hold shift when using arrow keys for slower/finer control.
...
~~Single player:
You are the blue planet. You play against the computer (which just picks a random angle so it's pretty easy...).
...
Server code template from Socket.io.
